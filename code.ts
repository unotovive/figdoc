...
if (figma.command === 'setting') {
    ...
    const baseColor: SolidPaint = figma.command === 'createDoc1' ? { type: "SOLID", color: { r: 0.4274, g: 0.6941, b: 0.3333 } } : figma.command === 'createDoc2' ? { type: "SOLID", color: { r: 0.8980, g: 0.2901, b: 0.4 } } : { type: "SOLID", color: { r: 0.3137, g: 0.5333, b: 0.8666 } };

    const titleColor: SolidPaint = { type: "SOLID", color: { r: 1, g: 1, b: 1 } };
    const contentColor: SolidPaint = { type: "SOLID", color: { r: 0.1176, g: 0.1176, b: 0.1176 } };
